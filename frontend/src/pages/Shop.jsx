...
const Shop = () => {
    ...
    return (
        <div className='min-h-screen bg-gray-100'>
            <button className='absolute top-4 left-4 z-20 flex items-center gap-2 bg-black/50 hover:bg-black/70 text-white px-3 py-2 rounded-full shadow-md transition cursor-pointer'
             onClick={()=>navigate("/")}>
            <FaArrowLeft/>
               <span>Back</span>
            </button>
