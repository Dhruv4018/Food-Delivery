    ...
    return (
        <div className='min-h-screen bg-[#fff9f6] flex flex-col justify-center items-center px-4 text-center relative overflow-hidden'>
            ...
            <p className='text-gray-600 max-w-md mb-6'>
                ...
                You can track you order status in the "My Orders" section.
            </p>
            <button className='bg-[#ff4d2d] hover:bg-[#e64526] text-white px-6 py-6 
            rounded-lg text-lg font-medium transition cursor-pointer' onClick={()=>navigate("/my-orders")}>
                Back To My Orders
            </button>
